...
public final class Constants {
    ...
    public static final class View {
        ...
        public static final String LOGIN_FXML_PATH = "views/login-view.fxml";
        ...
        public static final String MOVE_ITEM_FXML_PATH = "views/items/move-item.fxml";
    ...
    public static final class Img {
        ...
        public static final String IMG_ICON_PATH = "img/icon.png";
